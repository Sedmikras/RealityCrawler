...
public class HTMLDownloaderSelenium extends AbstractHTMLDownloader {
     ...
     */
    public Record processUrl(String url, Map<String, String> xpathMap) throws IndexOutOfBoundsException {
        ...
        if (dom != null) {
            ...
            return new Record(results.get("title").get(0), results.get("location").get(0), url, results.get("parameterName"), results.get("parameterValue"));
